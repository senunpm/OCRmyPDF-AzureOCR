...
from ocrmypdf_azureocr._azureocr import AzureOCRResult

log = logging.getLogger(__name__)

# Use files() to get a reference to the resource and then read it as binary
resource = files("ocrmypdf_azureocr").joinpath("pdf.ttf")
with resource.open("rb") as file:
    GLYPHLESS_FONT = file.read()
